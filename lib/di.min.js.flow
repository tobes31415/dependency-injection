...
declare var root: DIContext;
/**
 * Creates a new dependency injection root with no resolved instances.  Use for unit testing to provide mocks
 */
declare export function createRoot(): DIContext;
declare export default typeof root;
declare export { root as DI };
